...
goldIm.src="img/gold.png"; 
var rockIm = new Image();
rockIm.src="img/rock.png";
var diamondIM = new Image();
diamondIM.src="img/diamond.png";
    ...
    update() {
        switch (this.type) {
            ...
            case 2:
                ...
                this.width = 0.8 * this.game.getWidth();
                this.height = 0.8 * this.game.getWidth();
                this.IM = goldIm;
                this.score = 250;
                break;
            case 3:
                ...
                this.width = this.game.getWidth();
                this.height = 1.1 * this.game.getWidth();
                this.IM = rockIm;
                this.score = 50;
                break;
            case 4:
            ...
            case 5:
                ...
                this.height = 2.2 * this.game.getWidth();
                this.IM = rockIm;
                this.score = 50;
                break;
            case 6:
